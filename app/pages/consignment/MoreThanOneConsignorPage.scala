...
case object MoreThanOneConsignorPage extends QuestionPage[Boolean] {

  override def path: JsPath = TraderDetailsConsignmentSection.path \ toString

  override def toString: String = "moreThanOneConsignor"
  ...
  override def route(userAnswers: UserAnswers, mode: Mode): Option[Call] =
    Some(controllers.consignment.routes.MoreThanOneConsignorController.onPageLoad(userAnswers.lrn, mode))
}
