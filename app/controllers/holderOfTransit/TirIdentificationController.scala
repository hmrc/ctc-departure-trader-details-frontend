...
import pages.holderOfTransit.TirIdentificationPage
      ...
      form
        ...
        .fold(
          ...
          value => {
            ...
            TirIdentificationPage.writeToUserAnswers(value).updateTask().writeToSession(sessionRepository).navigateWith(navigator)
          }
        )
  }
}
