...
import pages.consignment.consignor.{AddressPage, CountryPage, NamePage}
            ...
            form(isPostalCodeRequired)
              ...
              .fold(
                ...
                value => {
                  ...
                  AddressPage.writeToUserAnswers(value).updateTask().writeToSession(sessionRepository).navigateWith(navigator)
                }
              )
        }
    }
