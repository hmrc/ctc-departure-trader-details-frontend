...
import views.html.consignment.consignee.EoriYesNoView
      ...
      form
        ...
        .fold(
          ...
          value => {
            ...
            EoriYesNoPage.writeToUserAnswers(value).updateTask().writeToSession(sessionRepository).navigateWith(navigator)
          }
        )
  }
}
